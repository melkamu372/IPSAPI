...
exports.GenerateAccessToken = async()=> {
  try {
    ...
    const token = await axios.post(`${access_url}`, {
      grant_type: 'password',
      username: username,
      password: password
    }, {
      headers: {
        ...
        'jwt-assertion': 'eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJfeGlQSDB2bXRKck9qT3JFQ0c2VFlNRk5zUFNuaExZN0duaUlaYTJtS2owIn0.eyJleHAiOjE3MTkyNzM0OTUsImlhdCI6MTcxOTIzNzQ5NSwianRpIjoiMGNiMDJjOWYtNTIyZC00YWVmLTkzZjktNWUyYzEzYmU3YmNkIiwiaXNzIjoiaHR0cDovLzE5Mi4xNjguMjAuNDU'
      }
    });
...
exports.RefreshToken = async (refresh_token) => {
    try {
      ...
      // Assuming token retrieval was successful, you can handle the token here
      //const token ={"access_token":"eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJfeGlQSDB2bXRKck9qT3JFQ0c2VFlNRk5zUFNuaExZN0duaUlaYTJtS2owIn0..hZ_inWzu-A_qAX7XmytduMwDX_6Bs69QkqZaN6Ntzf6A3_9h1FoOheWFipCHz9OtEJNrGAGp9kMCoOSdRF3ukebHWH3YWz2GPQOJdcd_1bTdo7LbCSMPCd5_NHOZSPqQ5GjVnbWp0XAO0cgpRcBlZI-WGV_ElxZaUqxA-bakhbug7XBZCyYVs5SSewpmcqVjo67EszHpYqMC1sZvjTxuwYlZXyGYAcrYP1_se7uENtYrlvVvQA1pN6P0XRPlv5SaOvjwTVdMHjmCBy8U9DeCETTWqgW5IMwFbppJ4wux8VbNrimfteS7YHnyNxoe215mY-5xAVkpXTibctToMq8TrQ","expires_in":36000,"refresh_expires_in":1800,"refresh_token":"eyJhbGciOiJIUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICIxNTRhYWMzOS00YTUyLTQ5NmUtODBlYi00MThjM2Y2NzcxOTMifQ..OSkOB7kdjpXCOhATdcP_PeJQ_7y75CI0XF-k8AKEGiU","token_type":"Bearer","not-before-policy":0,"session_state":"53365399-94ce-4430-a651-251164471a01","scope":"profile email"};
...
if (!accessToken) {
   ...
   const token = await token_model.findOne({ where: { accessToken: accessToken } });
    if (!token) {
        return {   
            status: true,
            message: "Token not found" };
    ...
    const bufferTime = 30 * 60 * 1000; // 30 minutes buffer time in milliseconds
    const willExpireIn30Minutes = expirationTime - now.getTime() <= bufferTime;
    if (willExpireIn30Minutes) {
      return {
        status: true,
        message: "Token either expired or will expire in 30 minutes"
      };
    } else {
      return {
        status: false,
        message: "Token will not expire in 30 minutes"
      };
    }
...
exports.getAccessToken=async()=> {
    try {
    let token = await token_model.findOne({
            order: [['createdAt', 'DESC']]
          });  
       if (!token) {
         token= await AccessTokenGenerator();
       }
       const now = new Date();
       const expirationTime = token.expiresAt.getTime();
       const bufferTime = 30 * 60 * 1000; // 30 minutes buffer time in milliseconds
